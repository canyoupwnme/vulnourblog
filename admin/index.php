<?php
  ...
  if ($_COOKIE["isadmin"] == "c4ca4238a0b923820dcc509a6f75849b" ) {
...
<body>
  ...
  <div class="slidebar">
    ...
    <ul>
      ...
      <li><a href="index.php?page=yaziekle.php">Yazi Ekle</a></li>
      <li><a href="index.php?page=yazisil.php">Yazi Sil</a></li>
      <li><a href="index.php?page=yorumsil.php">Yorum Sil</a></li>
      <li><a href="index.php?page=kategoriekle.php">Kategori Ekle</a></li>
      <li><a href="index.php?page=kategorisil.php">Kategori Sil</a></li>
